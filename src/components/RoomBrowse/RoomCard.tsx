...
export function RoomCard({ room }: RoomCardProps) {
  return (
    <div className="bg-[#13131a] border border-white/8 rounded-2xl p-5 flex flex-col gap-3
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <h3 className="text-white font-semibold text-base leading-snug truncate">{room.name}</h3>
        </div>
